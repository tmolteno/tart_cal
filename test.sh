...
python3 raw_cal/tart_cal.py --api ${TART_API}  --iterations ${TART_CAL_ITERATIONS} --pointing ${TART_CAL_POINTING} --elevation ${TART_CAL_ELEVATION}  --data ${DATA_DIR}  --dir ${OUTPUT_DIR}
